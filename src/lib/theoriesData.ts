...
export const theories: Theory[] = [
...

  {
    ...
    resources: [
      ...
      {
        label: "Wikipedia — Gustaf Aulén (Swedish theologian)",
        url: "https://en.wikipedia.org/wiki/Gustaf_Aul%C3%A9n",
        kind: "reference",
      },
    ],
    accentHex: "#917614",
...

  {
    ...
    resources: [
      ...
      {
        label: "Stanford Encyclopedia of Philosophy — “Peter Abelard”",
        url: "https://plato.stanford.edu/entries/abelard/",
        kind: "encyclopedia",
      },
      {
        label: "Hastings Rashdall, The Idea of Atonement in Christian Theology (1919)",
        url: "https://en.wikipedia.org/wiki/Hastings_Rashdall",
        kind: "academic",
...

  {
    ...
    resources: [
      ...
      {
        label: "Stanford Encyclopedia of Philosophy — “Anselm of Canterbury”",
