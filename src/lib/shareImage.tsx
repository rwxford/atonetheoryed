...
import { decodeShareCode } from "./shareCodec";
import { evaluateQuiz } from "./quizEngine";
import { shareHeadline } from "./shareText";
import { getTheory } from "./theoriesData";
import type { QuizResult, TheoryId } from "./types";

export const SHARE_IMAGE_ALT = "A Theories of Atonement quiz result";
...
export function buildShareImageResponse(code: string) {
